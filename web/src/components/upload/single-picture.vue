<template>
	<div class="ly-upload" :class="{'ly-upload-round':round}" :style="style">
		...
		<div v-if="file && file.status=='success'" class="ly-upload__img">
			<el-image class="image" :src="file.url" :preview-src-list="[file.url]" fit="cover" hide-on-click-modal append-to-body>
...
<script>
	...
	const lyCropper = defineAsyncComponent(() => import('@/components/upload/lycropper'))
...
<style scoped>
	.el-form-item.is-error .ly-upload .el-upload--picture-card {border-color: var(--el-color-danger);}
	.ly-upload .el-upload--picture-card {border-radius: 0;}

	.ly-upload .uploader,.ly-upload:deep(.el-upload) {width: 100%;height: 100%;}

	.ly-upload__img {width: 100%;height: 100%;position: relative;}
	.ly-upload__img .image {width: 100%;height: 100%;}
	.ly-upload__img-actions {position: absolute;top:0;right: 0;display: none;}
	.ly-upload__img-actions span {display: flex;justify-content: center;align-items: center;width: 25px;height:25px;cursor: pointer;color: #fff;}
	.ly-upload__img-actions span i {font-size: 12px;}
	.ly-upload__img-actions .del {background: #F56C6C;}
	.ly-upload__img:hover .ly-upload__img-actions {display: block;}
	.ly-upload__img-slot {display: flex;justify-content: center;align-items: center;width: 100%;height: 100%;font-size: 12px;background-color: var(--el-fill-color-lighter);}

	.ly-upload__uploading {width: 100%;height: 100%;position: relative;}
	.ly-upload__progress {position: absolute;width: 100%;height: 100%;display: flex;justify-content: center;align-items: center;background-color: var(--el-overlay-color-lighter);z-index: 1;padding:10px;}
	.ly-upload__progress .el-progress {width: 100%;}
	.ly-upload__uploading .image {width: 100%;height: 100%;}

	.ly-upload .file-empty {width: 100%;height: 100%;display: flex;justify-content: center;align-items: center;flex-direction: column;}
	.ly-upload .file-empty i {font-size: 28px;}
	.ly-upload .file-empty h4 {font-size: 12px;font-weight: normal;color: #8c939d;margin-top: 8px;}

	.ly-upload.ly-upload-round {border-radius: 50%;overflow: hidden;}
	.ly-upload.ly-upload-round .el-upload--picture-card {border-radius: 50%;}
	.ly-upload.ly-upload-round .ly-upload__img-actions {top: auto;left: 0;right: 0;bottom: 0;}
	.ly-upload.ly-upload-round .ly-upload__img-actions span {width: 100%;}
</style>