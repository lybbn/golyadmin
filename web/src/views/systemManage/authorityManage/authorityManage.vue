<template>
    <div class="lyauthcontainer">
        ...
        <div class="auth-outer">
            <div style="border-right: 1px solid var(--el-border-color-light);">
                ...
                <div class="auth-item" style="height: calc(100vh - 415px);">
                    <el-scrollbar>
            ...
            <div class="auth-item" style="height: calc(100vh - 115px);">
                <div class="auth-title">
                    菜单授权：
                    <el-tooltip
                        effect="dark"
