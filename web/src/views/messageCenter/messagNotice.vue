    ...
    <div :class="{'ly-is-full':isFull}">
        <div class="tableSelect" ref="tableSelect">
            <el-form :inline="true" :model="formInline" label-position="left">
                ...
                <!--                    </el-date-picker>-->
                <!--                </el-form-item>-->
                <el-form-item label="" v-show="hasPermission('messagNotice','Search')"><el-button  @click="search" type="primary" icon="Search">查询</el-button></el-form-item>
...
<!--            <el-table-column min-width="80" prop="sort" label="排序"></el-table-column>-->
            <el-table-column min-width="100" label="目标类型">
                <template #default="scope">
                    <el-tag v-if="scope.row.target_type == 1">平台公告</el-tag>
                    <el-tag v-else-if="scope.row.target_type == 2" type="warning">按用户</el-tag>
                    <span v-else >按用户</span>
                </template>
            </el-table-column>
...
<!--            </el-table-column>-->
            ...
            <el-table-column label="操作" fixed="right" width="180">
                ...
                <template #default="scope">
                    <span class="table-operate-btn" @click="handleEdit(scope.row,'edit')" v-show="hasPermission('messagNotice','Update')">编辑</span>
                    <span class="table-operate-btn" @click="handleEdit(scope.row,'delete')" v-show="hasPermission('messagNotice','Delete')">删除</span>
                </template>
            </el-table-column>
        </el-table>
