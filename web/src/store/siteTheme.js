...
export const useSiteThemeStore = defineStore('siteTheme', {
    state:() => {
        return {
            ...
            //折叠菜单
            collapsed:getStorage('collapsed')?getStorage('collapsed'):!config.MENU_IS_COLLAPSE,
            //语言
            ...
            //项目布局
            programLayout:getStorage('programLayout')?getStorage('programLayout'):config.PROGRAM_LAYOUT,
            //菜单宽度
            ...
            pagingLayout:getStorage('pagingLayout')?getStorage('pagingLayout'):config.PAGING_LAYOUT,
    ...
    actions: {
        ...
        setProgramLayout(val){
            this.programLayout = val
            setStorage('programLayout',val);
        },
        setPagingLayout(val){
            this.pagingLayout = val
            setStorage('pagingLayout',val);
        },
    },
})